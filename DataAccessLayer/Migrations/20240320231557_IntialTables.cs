    ...
    public partial class IntialTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("16f8b600-be60-45c9-ae68-5711cd3966e6"), "Mobile Products" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("8f0410b4-aad1-4bf2-a6d8-e5f155f3fcf2"), "Smart Watches" });
